...
import { PROFESSIONAL_PROJECTS } from "../content/profile";

export const ProfessionalProjectsPage: React.FC<{
    ...
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mx-auto max-w-6xl px-6 pt-28 pb-20 md:pt-32 md:pb-28">
        ...
        <div className="mt-8 grid gap-3 md:gap-4">
          {PROFESSIONAL_PROJECTS.points.map((p, i) => (
            <AnimatedOnScroll
              key={p}
              staggerIndex={4 + i}
